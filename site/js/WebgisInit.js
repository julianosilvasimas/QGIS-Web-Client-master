...
var googleStreetLayer;
var googleMapLayer;
var googleHybridLayer;
...
Ext.onReady(function () {
	...
	if (enableGoogleCommercialMaps) {
		...
		googleStreetLayer = new OpenLayers.Layer.Google(
			"Google Street",
			{numZoomLevels: ZOOM_LEVELS, isBaseLayer: true}
		);
		baseLayers.push(googleStreetLayer);
		googleHybridLayer = new OpenLayers.Layer.Google(
			"Google Híbrido",
			{type: google.maps.MapTypeId.HYBRID, numZoomLevels: ZOOM_LEVELS, isBaseLayer: true}
		);
		baseLayers.push(googleHybridLayer);
